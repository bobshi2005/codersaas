...
MetronicApp.config(['$stateProvider', '$urlRouterProvider','$httpProvider',function($stateProvider, $urlRouterProvider,$httpProvider) {
    ...
    $stateProvider
        ...
        .state('login', {
            url: "/login",
            templateUrl: "views/login5.html?version=2017093001",
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([
                            ...
                            "js/controllers/LoginController.js?version=2017093001",
        ...
        .state('regist', {
            url: "/regist",
            templateUrl: "views/regist.html?version=2017093001",
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([
                            ...
                            "../assets/global/plugins/jquery.min.js",
                            'js/controllers/RegistController.js?version=2017093001'
                    ]);
                }]
            }
        })
        .state('passback', {
            url: "/passback",
            templateUrl: "views/passback.html?version=2017093001",
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([
                            "../assets/apps/login_files/login.css",
                            "../assets/global/plugins/jquery.min.js",
                            'js/controllers/PassBackController.js?version=2017093001'
                    ]);
                }]
            }
        })
        .state('main', {
            url: "/main",
            templateUrl: "views/main.html?version=2017093001",
        ...
        .state('main.home', {
            url: "/home",
            templateUrl: "views/home.html?version=2017093001",
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([
                      "../assets/global/plugins/jquery.min.js",
        ...
        .state('main.home.dashboard', {
            url: "/dashboard",
            templateUrl: "views/dashboard2.html?version=2017093001",
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([
                            ...
                            "../assets/global/plugins/datatables/plugins/bootstrap/datatables.bootstrap.js",
                            'js/scripts/world.js?version=2017093001',
                            'js/controllers/GeneralPageController.js?version=2017093001',
                            'js/controllers/HomeController2.js?version=2017093001'
                    ])
                }]
            }
        })
        .state('main.home.dashboard2', {
            url: "/dashboard2",
            templateUrl: "views/dashboard.html?version=2017093001",
            controller: 'HomeController',
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([
                            'js/controllers/GeneralPageController.js?version=2017093001',
                            'js/controllers/HomeController.js?version=2017093001'
                      ])
                }]
            }
        })
        .state('main.device', {
            url: "/device",
            templateUrl: "views/device.html?version=2017093001",
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([
                          "../assets/global/plugins/jquery.min.js",
        ...
        .state('main.device.monitor', {
            url: "/monitor",
            templateUrl: "views/monitor.html?version=2017093001",
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([
                            ...
                            "js/controllers/DeviceMonitorController.js?version=2017093001 "
        ...
        .state('main.device.alarm', {
            url: "/alarm",
            templateUrl: "views/alarm.html?version=2017093001",
            controller: 'AlarmController',
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([
                            'js/controllers/AlarmController.js?version=2017093001'
                    ])
                }]
            }
        })
        .state('main.asset', {
            url: "/asset",
            templateUrl: "views/asset.html?version=2017093001",
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        "../assets/global/plugins/jquery.min.js",
        ...
        .state('main.asset.modalmanage', {
            url: "/modalmanage",
            templateUrl: "views/asset-modalmanage.html?version=2017093001",
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([
                            ...
                            // "../assets/pages/scripts/slider.js?version=2017093001 ",
                            'js/controllers/ModalManageController.js?version=2017093001'
        ...
        .state('main.asset.infomanage', {
            url: "/infomanage",
            templateUrl: "views/asset-infomanage.html?version=2017093001",
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([
                            ...
                            "../assets/global/plugins/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css",
                            "../assets/global/plugins/bootstrap-datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js",
                            'js/controllers/InfoManageController.js?version=2017093001'
                    ])
                }]
            }
        })
        .state('main.asset.connectdevice', {
            ...
            templateUrl: "views/asset-connectdevice.html?version=2017093001",
            controller: 'ConnectDeviceController',
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([
                          'js/controllers/ConnectDeviceController.js?version=2017093001'
        ...
        .state('main.asset.warehousemanage', {
            url: "/warehousemanage",
            templateUrl: "views/asset-warehousemanage.html?version=2017093001",
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([
                          "../assets/global/plugins/jquery.min.js",
                          "../assets/global/plugins/bootstrap/js/bootstrap.min.js",
                          'js/controllers/WarehouseController.js?version=2017093001'
        ...
        .state('main.asset.warelocation', {
            ...
            templateUrl: "views/asset-warelocation.html?version=2017093001",
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([
                          "../assets/global/plugins/jquery.min.js",
                          "../assets/global/plugins/bootstrap/js/bootstrap.min.js",
                          'js/controllers/WarelocationController.js?version=2017093001'
        ...
        .state('main.asset.stocksmanage', {
            url: "/stocksmanage",
            templateUrl: "views/asset-stocksmanage.html?version=2017093001",
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([
                          "../assets/global/plugins/jquery.min.js",
                          "../assets/global/plugins/bootstrap/js/bootstrap.min.js",
                          'js/controllers/StocksmanageController.js?version=2017093001'
        ...
        .state('main.asset.mtcmanage', {
            url: "/mtcmanage",
            templateUrl: "views/asset-mtcmanage.html?version=2017093001",
            controller: 'MtcManageController',
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([
                            'js/controllers/MtcManageController.js?version=2017093001'
        ...
        .state('main.asset.partcategory', {
            url: "/partcategory",
            templateUrl: "views/asset-partcategory.html?version=2017093001",
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([
                            "../assets/global/plugins/jquery.min.js",
                            "../assets/global/plugins/bootstrap/js/bootstrap.min.js",
                            'js/controllers/PartCategoryController.js?version=2017093001'
        ...
        .state('main.asset.partmanage', {
            url: "/partmanage",
            templateUrl: "views/asset-partmanage.html?version=2017093001",
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([
                            "../assets/global/plugins/jquery.min.js",
                            "../assets/global/plugins/bootstrap/js/bootstrap.min.js",
                            'js/controllers/PartController.js?version=2017093001'
        ...
        .state('main.asset.worksheet', {
            url: "/worksheet",
            templateUrl: "views/asset-worksheet.html?version=2017093001",
            controller: 'WorkSheetController',
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([
                            'js/controllers/WorkSheetController.js?version=2017093001'
        ...
        .state('main.asset.worksheetdetail', {
            url: "/worksheetdetail",
            templateUrl: "views/asset-worksheetdetail.html?version=2017093001",
            controller: 'WorksheetdetailController',
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([
                            'js/controllers/WorksheetdetailController.js?version=2017093001'
        ...
        .state('main.setting', {
            url: "/setting",
            templateUrl: "views/setting.html?version=2017093001",
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        "../assets/global/plugins/jquery.min.js",
        ...
        .state('main.setting.userboard', {
            url: "/userboard",
            templateUrl: "views/setting-userboard.html?version=2017093001",
            controller: 'UserboardController',
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([
                            'js/controllers/UserboardController.js?version=2017093001'
        ...
        .state('main.setting.usermanage', {
            url: "/usermanage",
            templateUrl: "views/setting-usermanage.html?version=2017093001",
            controller: 'UsermanageController',
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([
                            'js/controllers/UsermanageController.js?version=2017093001'
        ...
        .state('main.asset.netgate', {
            url: "/netgate",
            templateUrl: "views/setting-netgate.html?version=2017093001",
            controller: 'NetgateController',
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([
                            'js/controllers/NetgateController.js?version=2017093001'
        ...
        .state('main.setting.customer', {
            url: "/customer",
            templateUrl: "views/setting-customer.html?version=2017093001",
            controller: 'CustomerController',
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([
                            'js/controllers/CustomerController.js?version=2017093001'
        ...
        .state('main.setting.notify', {
            url: "/notify",
            templateUrl: "views/setting-notify.html?version=2017093001",
            controller: 'NotifyController',
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([
                            'js/controllers/NotifyController.js?version=2017093001'
        ...
        .state('main.setting.helpConnectRTU', {
            url: "/helpConnectRTU",
            templateUrl: "views/setting-help-connectRTU.html?version=2017093001",
            controller: 'HelpController',
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([
                            'js/controllers/HelpController.js?version=2017093001'
        ...
        .state('main.setting.helpSetRTU', {
            url: "/helpSetRTU",
            templateUrl: "views/setting-help-setRTU.html?version=2017093001",
            controller: 'HelpController',
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        ...
                        name: 'MetronicApp',
                        files: [
                            'js/controllers/UISelectController.js?version=2017093001 '
                        ]
                    }]);
                }]
            }
                ...
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        ...
                        files: [
                            ...
                            'js/controllers/UserProfileController.js?version=2017093001 '
                        ]
                    });
                }]
            }
                ...
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        ...
                        files: [
                            ...
                            'js/controllers/TodoController.js?version=2017093001 '
                        ]
                    });
                }]
            }
