...
MetronicApp.config(['$stateProvider', '$urlRouterProvider', function($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider
        ...
        .state('login', {
            url: "/login",
            templateUrl: "views/login5.html?version=2017091502",
                ...
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        ...
                        files: [
                            ...
                            "js/controllers/LoginController.js?version=2017091502 ",
        ...
        .state('regist', {
            url: "/regist",
            templateUrl: "views/regist.html?version=2017091502",
                ...
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        ...
                        files: [
                            ...
                            'js/controllers/RegistController.js?version=2017091502 '
                        ]
                    }]);
                }]
            }
        ...
        .state('passback', {
            url: "/passback",
            templateUrl: "views/passback.html?version=2017091502",
                ...
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        ...
                        files: [
                            "../assets/apps/login_files/login.css",
                            "../assets/apps/login_files/jquery-1.8.3.min.js",
                            'js/controllers/PassBackController.js?version=2017091502 '
                        ]
                    }]);
                }]
            }
        ...
        .state('main', {
            url: "/main",
            templateUrl: "views/main.html?version=2017091502",
                ...
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        ...
                        files: [
                          ...
                          'js/scripts/world.js?version=2017091502',
                        ]
                    }])
                }]
            }
        ...
        .state('main.home', {
            url: "/home",
            templateUrl: "views/home.html?version=2017091502",
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        name: 'homeApp',
        ...
        .state('main.home.dashboard', {
            url: "/dashboard",
            templateUrl: "views/dashboard2.html?version=2017091502",
                    ...
                    return $ocLazyLoad.load([
                      {
                        ...
                        files: [
                            ...
                            'js/controllers/GeneralPageController.js?version=2017091502',
                            'js/controllers/HomeController2.js?version=2017091502 '
        ...
        .state('main.home.dashboard2', {
            url: "/dashboard2",
            templateUrl: "views/dashboard.html?version=2017091502",
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        ...
                        files: [
                            'js/controllers/GeneralPageController.js?version=2017091502 ',
                            'js/controllers/HomeController.js?version=2017091502 '
        ...
        .state('main.device', {
            url: "/device",
            templateUrl: "views/device.html?version=2017091502",
            cache: false,
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
        ...
        .state('main.device.devicemap', {
            url: "/devicemap",
            templateUrl: "views/devicemap.html?version=2017091502",
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        name: 'devicemapApp',
                        files: [
                            "js/controllers/MapController.js?version=2017091502 "
                        ]
                    }])
                }]
            }
        ...
        .state('main.device.monitor', {
            url: "/monitor",
            templateUrl: "views/monitor.html?version=2017091502",
                    ...
                    return $ocLazyLoad.load([
                      {
                        ...
                        files: [
                          ...
                          files: [
                              ...
                              "js/controllers/DeviceMonitorController.js?version=2017091502 "
                          ]
                      }])
                }]
            }
        ...
        .state('main.device.alarm', {
            url: "/alarm",
            templateUrl: "views/alarm.html?version=2017091502",
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        ...
                        insertBefore: '#ng_load_plugins_before', // load the above css files before '#ng_load_plugins_before'
                        files: [
                            'js/controllers/AlarmController.js?version=2017091502 '
                        ]
                    }])
                }]
            }
        ...
        .state('main.asset', {
            url: "/asset",
            templateUrl: "views/asset.html?version=2017091502",
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        name: 'assetApp',
        ...
        .state('main.asset.modalmanage', {
            url: "/modalmanage",
            templateUrl: "views/asset-modalmanage.html?version=2017091502",
                ...
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        ...
                        files: [
                            ...
                            "../assets/pages/css/slider.css",
                            "../assets/global/plugins/slick/slick.min.js",
                            // "../assets/pages/scripts/slider.js?version=2017091502 ",
                            'js/controllers/ModalManageController.js?version=2017091502 '
                        ]
                    }])
                }]
            }
        ...
        .state('main.asset.infomanage', {
            url: "/infomanage",
            templateUrl: "views/asset-infomanage.html?version=2017091502",
                ...
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        ...
                        files: [
                            ...
                            "../assets/global/plugins/bootstrap-datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js",
                            "../assets/global/plugins/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css",
                            'js/controllers/InfoManageController.js?version=2017091502 '
                        ]
                    }])
                }]
            }
        ...
        .state('main.asset.connectdevice', {
            ...
            templateUrl: "views/asset-connectdevice.html?version=2017091502",
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        ...
                        files: [
                          'js/controllers/ConnectDeviceController.js?version=2017091502 '
                        ]
                    }])
                }]
            }
        ...
        .state('main.asset.warehousemanage', {
            url: "/warehousemanage",
            templateUrl: "views/asset-warehousemanage.html?version=2017091502",
                ...
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        ...
                        files: [
                          "../assets/global/plugins/jquery.min.js",
                          "../assets/global/plugins/bootstrap/js/bootstrap.min.js",
                          'js/controllers/WarehouseController.js?version=2017091502 '
                        ]
                    }])
                }]
            }
        ...
        .state('main.asset.warelocation', {
            ...
            templateUrl: "views/asset-warelocation.html?version=2017091502",
                ...
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        ...
                        files: [
                          "../assets/global/plugins/jquery.min.js",
                          "../assets/global/plugins/bootstrap/js/bootstrap.min.js",
                          'js/controllers/WarelocationController.js?version=2017091502 '
                        ]
                    }])
                }]
            }
        ...
        .state('main.asset.stocksmanage', {
            url: "/stocksmanage",
            templateUrl: "views/asset-stocksmanage.html?version=2017091502",
                ...
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        ...
                        files: [
                          "../assets/global/plugins/jquery.min.js",
                          "../assets/global/plugins/bootstrap/js/bootstrap.min.js",
                          'js/controllers/StocksmanageController.js?version=2017091502 '
                        ]
                    }])
                }]
            }
        ...
        .state('main.asset.mtcmanage', {
            url: "/mtcmanage",
            templateUrl: "views/asset-mtcmanage.html?version=2017091502",
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        name: 'mtcmanageApp',
                        files: [
                            'js/controllers/MtcManageController.js?version=2017091502 '
                        ]
                    }])
                }]
            }
        ...
        .state('main.asset.partcategory', {
            url: "/partcategory",
            templateUrl: "views/asset-partcategory.html?version=2017091502",
                ...
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        ...
                        files: [
                            "../assets/global/plugins/jquery.min.js",
                            "../assets/global/plugins/bootstrap/js/bootstrap.min.js",
                            'js/controllers/PartCategoryController.js?version=2017091502 '
                        ]
                    }])
                }]
            }
        ...
        .state('main.asset.partmanage', {
            url: "/partmanage",
            templateUrl: "views/asset-partmanage.html?version=2017091502",
                ...
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        ...
                        files: [
                            "../assets/global/plugins/jquery.min.js",
                            "../assets/global/plugins/bootstrap/js/bootstrap.min.js",
                            'js/controllers/PartController.js?version=2017091502 '
                        ]
                    }])
                }]
            }
        ...
        .state('main.asset.worksheet', {
            url: "/worksheet",
            templateUrl: "views/asset-worksheet.html?version=2017091502",
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        name: 'worksheetApp',
                        files: [
                            'js/controllers/WorkSheetController.js?version=2017091502 '
                        ]
                    }])
                }]
            }
        ...
        .state('main.asset.worksheetdetail', {
            url: "/worksheetdetail",
            templateUrl: "views/asset-worksheetdetail.html?version=2017091502",
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        ...
                        files: [
                            'js/controllers/WorksheetdetailController.js?version=2017091502 '
                        ]
                    }])
                }]
            }
        ...
        .state('main.setting', {
            url: "/setting",
            templateUrl: "views/setting.html?version=2017091502",
        })
        .state('main.setting.userboard', {
            url: "/userboard",
            templateUrl: "views/setting-userboard.html?version=2017091502",
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        name: 'userboardApp',
                        files: [
                            'js/controllers/UserboardController.js?version=2017091502 '
                        ]
                    }])
                }]
            }
        ...
        .state('main.setting.usermanage', {
            url: "/usermanage",
            templateUrl: "views/setting-usermanage.html?version=2017091502",
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        name: 'usermanageApp',
                        files: [
                            'js/controllers/UsermanageController.js?version=2017091502 '
                        ]
                    }])
                }]
            }
        ...
        .state('main.asset.netgate', {
            url: "/netgate",
            templateUrl: "views/setting-netgate.html?version=2017091502",
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        name: 'netgateApp',
                        files: [
                            'js/controllers/NetgateController.js?version=2017091502 '
                        ]
                    }])
                }]
            }
        ...
        .state('main.setting.customer', {
            url: "/customer",
            templateUrl: "views/setting-customer.html?version=2017091502",
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        name: 'customerApp',
                        files: [
                            'js/controllers/CustomerController.js?version=2017091502 '
                        ]
                    }])
                }]
            }
        ...
        .state('main.setting.notify', {
            url: "/notify",
            templateUrl: "views/setting-notify.html?version=2017091502",
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        name: 'notifyApp',
                        files: [
                            'js/controllers/NotifyController.js?version=2017091502 '
                        ]
                    }])
                }]
            }
        ...
        .state('main.setting.helpConnectRTU', {
            url: "/helpConnectRTU",
            templateUrl: "views/setting-help-connectRTU.html?version=2017091502",
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        name: 'helpApp',
                        files: [
                            'js/controllers/HelpController.js?version=2017091502 '
                        ]
                    }])
                }]
            }
        ...
        .state('main.setting.helpSetRTU', {
            url: "/helpSetRTU",
            templateUrl: "views/setting-help-setRTU.html?version=2017091502",
            controller: 'HelpController',
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        ...
                        name: 'MetronicApp',
                        files: [
                            'js/controllers/UISelectController.js?version=2017091502 '
                        ]
                    }]);
                }]
            }
                ...
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        ...
                        files: [
                            ...
                            'js/controllers/UserProfileController.js?version=2017091502 '
                        ]
                    });
                }]
            }
                ...
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        ...
                        files: [
                            ...
                            'js/controllers/TodoController.js?version=2017091502 '
                        ]
                    });
                }]
            }
