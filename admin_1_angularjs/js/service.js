...
AppService.factory('deviceApi',['$http', '$q', 'sharedataApi',function($http, $q, sharedataApi) {
  ...
  //产线管理
      ...
      //产线设备列表
      service.getProductLineEquipmentsList = function(productLineId,order, offset, limit) {
          var d = $q.defer();
          $http({
              method: 'get',
              url: deviceUrl+ '/manage/'+productLineId+'/equipment/list',
              headers: {"Accept":"application/json"},
              withCredentials: true,
              params: {order:'asc', offset:offset, limit:limit}
          }).then(function(response) {
      ...
      //新增产线设备
      service.createProductLineEquipment = function(productLineId,params) {
          var d = $q.defer();
          $http({
              method: 'post',
              url: deviceUrl+ '/manage/'+productLineId+'/equipment/create',
              headers: {"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"},
              data:params,
              withCredentials: true,
              transformRequest: function(obj) {
      ...
      //修改产线设备
      service.updateProductLineEquipment = function(productLineId,params) {
          var d = $q.defer();
          $http({
              method: 'post',
      ...
      //删除产线设备
      service.deleteProductLineEquipment = function(productLineId,ids) {
          var d = $q.defer();
          $http({
              method: 'get',
              url: deviceUrl+ '/manage/'+productLineId+'/equipment/delete/'+ids,
              headers: {"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"},
              withCredentials: true,
          }).then(function(response) {
              d.resolve(response);
